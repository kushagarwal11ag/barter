const conf = {
	...
	userImagesId: String(process.env.NEXT_PUBLIC_APPWRITE_BUCKET_USER_IMAGES_ID),
	productImagesId: String(process.env.NEXT_PUBLIC_APPWRITE_BUCKET_POST_IMAGES_ID),
};
