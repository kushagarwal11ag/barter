		...
		<>
			...
			<nav className="bg-gray-100 sm:fixed w-full z-10 sm:top-0">
				<div className="max-w-6xl mx-auto">
					<div className="flex justify-between ">
						<div className="hidden md:flex  items-center space-x-1">
							...
							{/* <a href="?contact" className="py-2 px-3  text-gray-700 hover:text-black">contact</a> */}
							{/* <a href="#" className="py-2 px-3  text-gray-700 hover:text-black">Contact</a> */}
						</div>
				...
				<div className="hidden " id="mobile-menu">
					<a
						className="block py-2 px-2 hover:text-gray-500 text-center"
						href="index.php"
					>
						Home
					</a>
					...
					<div className="grid gap-6 my-16 lg:grid-cols-3">
						<div className="flex flex-col p-8 space-y-4 rounded-md bg-gray-900">
							...
							<p className="text-2xl font-semibold">
								<b>SignUp</b> Create your free account and start
								exploring items!
							</p>
						</div>
						<div className="flex flex-col p-8 space-y-4 rounded-md bg-gray-900">
							...
							<p className="text-2xl font-semibold">
								<b>Upload items</b> Click a picture of your item
								and upload it.
							</p>
						</div>
						<div className="flex flex-col p-8 space-y-4 rounded-md bg-gray-900">
			...
			<div className="w-full p-4 text-center  border   shadow sm:p-8 bg-gray-800 border-gray-700">
				...
				<p className="mb-5 text-base  sm:text-lg text-gray-400">
					Swap items anytime with SwapEase on iOS & Android. Download
					the app today.
				</p>
