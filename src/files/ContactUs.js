	...
	return (
		<>
			...
			<div className="px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto  text-gray-900 rounded-lg ">
				...
				<form
					action="https://formspree.io/f/xayzokzk"
					method="POST"
				>
					<div className="">
						<div>
							...
							<input
								className="w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border-2 border-[darkgrey] focus:border-indigo-600 shadow-sm rounded-lg"
								type="text"
								placeholder=""
								name="name"
								required
						...
						<div className="mt-8">
							...
							<textarea
								required
								name="message"
								className="w-full mt-2 h-36 px-3 py-2 resize-none appearance-none bg-transparent outline-none border-2 border-[darkgrey] focus:border-indigo-600 shadow-sm rounded-lg"
							></textarea>
						</div>
						<div className="mt-8">
