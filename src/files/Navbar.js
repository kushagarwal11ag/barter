					...
					<Disclosure.Panel className="sm:hidden">
						<div className="space-y-1 px-2 pb-3 pt-2">
							...
							{page === "home" && (
								<Link
									href="/add"
									className="sm:ml-6 sm:block flex space-x-4 bg-gray-900 text-white text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 mx-1 text-sm font-medium"
								>
									Add Post
								</Link>
							)}
